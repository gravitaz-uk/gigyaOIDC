...
<div class="wrapper" id="main_wrapper">
    <div class="" id="errorsSwitch">
        ...
        <a href="<?php echo $urlPrefix?>/RPLogin.php">Return to the Main page</a>.
    </div>
    <script>
    ...
    <div class="content" id="consent_content">
        By clicking the button below you agree to share your data from the Gigya <a href="https://demo.gigya.com" target="_blank">Demo Site</a> with the Gigya <a href="<?php echo $urlPrefix?>" target="_blank">RP Site</a>.
        <!--<br />
...
$(document).ready(function () {
    ...
    $("#b_js_sigBtn").click(function(){
        var b_js_newUrl="OIDCProxyPage.php?mode=afterConsent&consent=" + b_js_consentOBJString + "&sig=" + consentObj2Sig;
